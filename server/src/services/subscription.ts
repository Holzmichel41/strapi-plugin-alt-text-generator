...
const subscriptionService = ({ strapi }: { strapi: Core.Strapi }) => {
  ...
  return {
    ...
    async getSubscription(): Promise<SubscriptionResponse> {
      ...
      console.log("[getSubscription] Getting subscription for license key:", licenseKey.substring(0, 10) + "...");
      try {
    ...
    async generateAltTextBatch(
      ...
      // Remove index from results as it's only needed internally
